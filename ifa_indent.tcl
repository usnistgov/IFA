...
# indent on these IFC entities
  set indentdat1 [list \
    ...
    IFCBEARING IFCBOREHOLE IFCBRIDGE IFCBUILTELEMENT IFCCAISSONFOUNDATION IFCCONVEYORSEGMENT IFCCOURSE IFCDEEPFOUNDATION IFCEARTHWORKSELEMENT \
    IFCFACILITY IFCGEOGRAPHICELEMENT IFCIMPACTPROTECTIONDEVICE IFCKERB IFCLIQUIDTERMINAL IFCMARINEFACILITY IFCMOORINGDEVICE IFCTENDONCONDUIT \
    IFCNAVIGATIONELEMENT IFCPAVEMENT IFCRAILWAY IFCREINFORCEDSOIL IFCROAD IFCSIGN IFCSIGNAL IFCTRACKELEMENT IFCVIBRATIONDAMPER \
  ]
